...
export default function PadCoverImage({ pad }: { pad: IPad }) {
  ...
  return (
    <div
      className="pad-cover absolute top-0 left-0 w-full h-[220px]"
      style={{
        backgroundImage: `linear-gradient(0deg, var(--editor-surface) 0%, color-mix(in srgb, var(--editor-surface) 62%, transparent) 35%, transparent 70%), url(${imgSrc})`,
        backgroundPosition: 'center',
        backgroundSize: '100%',
        backgroundColor: 'var(--editor-surface-elevated)',
      }}
    >

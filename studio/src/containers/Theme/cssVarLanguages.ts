...
export const varLanguages: IVarCSSLanguages = {
  ...
  "--editor-quote-text-color": "Editor quote color",
  "--editor-surface": "Editor surface",
  "--editor-surface-elevated": "Editor surface elevated",
  "--editor-text": "Editor text",
  "--editor-text-secondary": "Editor text secondary",
  "--editor-text-faint": "Editor text faint",
  "--editor-border": "Editor border",
  "--editor-accent": "Editor accent",
  "--editor-code-bg": "Editor code background",

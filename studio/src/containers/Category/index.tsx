...
export default function Category() {
  ...
  const { query: { recently, important, shared  }, filterByRecently, clearFilter, filterByImportant, filterByShared  } = usePadListStore()
  const isAllActive = !recently && !important && !shared;
